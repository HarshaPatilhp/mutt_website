          ...
          <div className="md:hidden pb-4">
            <nav className="flex flex-col space-y-2">
              ...
              <div className="border-t border-orange-500 pt-2">
                ...
                <Link href="/parayana-samithi" className="block pl-4 py-1 hover:text-orange-200">Paryana Samithi</Link>
              ...
              <Link href="/seva-list" className="hover:text-orange-200 transition-colors py-2">Sevas</Link>
              ...
              <div className="border-t border-orange-500 pt-2">
                ...
                <Link href="/latest-news" className="block pl-4 py-1 hover:text-orange-200">Latest News</Link>
              </div>
              ...
              <Link href="/contact" className="hover:text-orange-200 transition-colors py-2">Contact</Link>
            </nav>
          </div>
        )}
      </div>
